// elm-watch hot {"version":"2.0.0-beta.9","targetName":"main","webSocketConnection":8003,"webSocketToken":"3270e30a-46d2-4e11-bd31-8504e578cf07"}
"use strict";
(() => {
...
${indent.repeat(level)}}`;
  ...
  var WEBSOCKET_TOKEN = "3270e30a-46d2-4e11-bd31-8504e578cf07";
...
function _Platform_initialize(programType, isDebug, debugMetadata, flagDecoder, args, init, impl, stepperBuilder)
{
	...
	function setUpdateAndSubscriptions() {
		update = impl.bA || impl._impl.bA;
		subscriptions = impl.by || impl._impl.by;
		if (isDebug) {
	...
	return _Platform_initialize(
		...
		function(sendToApp, initialModel) {
			...
			return _Browser_makeAnimator(initialModel, function(model)
			{
				...
				var nextNode = impl.bB(model); // added by elm-watch
	...
	return _Platform_initialize(
		...
		function(sendToApp, initialModel) {
			...
			return _Browser_makeAnimator(initialModel, function(model)
			{
				...
				var doc = impl.bB(model); // added by elm-watch
...
function _Browser_application(impl)
{
	...
	var key = function() { key.a(impl.bu(_Browser_getUrl())); }; // added by elm-watch
	...
	return _Browser_document({
		...
		bs: function(flags)
		{
			...
			return A3(impl.bs, flags, globalThis.__ELM_WATCH_INIT_URL, key); // added by elm-watch
		},
		...
		bB: function(model) { return impl.bB(model); }, // added by elm-watch
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bq: 'hidden', bn: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bq: 'mozHidden', bn: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bq: 'msHidden', bn: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bq: 'webkitHidden', bn: 'webkitvisibilitychange' }
		: { bq: 'hidden', bn: 'visibilitychange' };
}
...
var $author$project$Main$OnAnimationFrame = {$: 5};
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aI: fragment, aK: host, d: path, aT: port_, aY: protocol, aZ: query};
	});
...
var $author$project$Main$p = {
	al: 'rgba(160,160,160,0.5)',
	aD: 'rgba(220, 0, 0, 0.3)',
	am: 'rgba(200, 200, 200, 0.5)',
	D: 'rgb(18, 147, 216)',
	an: _List_fromArray(
		[
			_Utils_Tuple3(0, 0, 1),
	...
	aj: 41.05,
	aU: _List_fromArray(
		[3.12, 16.51, 25, 36.8, 45.3, 54.6, 65.3, 92.45]),
	aV: _List_fromArray(
		[60.25, 99.7]),
	ak: 540,
	N: 980,
	_: 160,
	a2: 'M 5 5 L 4 6 H -{{size}} V 4 H 4',
	aA: 'M 0 0 L 5 5 L 0 10 L 5 10 L 10 5 L 5 0 Z',
	a3: 'M 2 4 l 1 1 l -1 1 l 0 1 l 2 -2 l -2 -2 M 3 3 l 2 2 l -2 2 l 1 0 l 2 -2 l -2 -2 M 5 3 l 2 2 l -2 2 l 1 0 l 2 -2 l -2 -2 M 7 3 l 1 1 l 0 -1 M 8 6 l -1 1 l 1 0',
	a4: 'M 6 2 A 3.2 3.2 0 1 0 8 7 A 2 2 0 1 1 6 2',
	a5: 'M 6.5 2 v 6 h 0.1 v -6 M 2.3 2 v 6 h 0.1 v -6 M 8 2 v 6 h 0.1 v -6 M 6 2 v 6 h 0.1 v -6 M 4 2 v 6 h 0.1 v -6',
	a6: 'M 7 3 h -3 c -1 0 -1 0 -1 -1 h -1 c 0 1 0 2 1 2 c 2.5 0 2.5 2 0 2 c -1 0 -1 1 0 1 h 4 c 1 0 1 -1 0 -1 c -2.5 0 -2.5 -2 0 -2 c 1 0 1 -1 0 -1',
	a7: 'M 4.5 2.5 L 2.5 2.5 L 2.5 7.5 L 4.5 7.5 M 7.5 2.5 L 5.5 2.5 L 5.5 7.5 L 7.5 7.5',
	a8: 'M 8 5 L 3 2 L 3 8',
	a9: 'M 3 5 l -1 0 a 3 3 1 0 0 3 3 a 0.5 0.5 1 1 0 0 -6 m 0 0 l 0 -1 l -2 1.5 l 2 1.5 l 0 -1 a 0.5 0.5 1 0 1 0 4 a 2 2 0 0 1 -2 -2',
	ba: 'M 7 6 a 0.5 0.5 1 1 0 0 2 a 0.5 0.5 1 1 0 0 -2 M 4 5 l 2 3 a 1 1 1 1 0 2 -2 l -3 -2 c 1 -2 -1 -3 -2 -2 l 1 1 l 0 1 l -1 0 l -1 -1 c -1 1 0 3 2 2',
	bb: 'M 7 3 L 3 3 L 3 7 L 7 7',
	bc: 'M 6 15 H 13 C 22 15 13 6 22 6 H 29 C 30.5 6 30.5 8 29 8 H 22 C 16 8 16 15 22 15 H 29 C 30.5 15 30.5 17 29 17 H 6 C 4.5 17 4.5 15 6 15 M 5 3 V 4 C 5 6 6 6 7 6 H 29 C 30.5 6 30.5 8 29 8 H 7 C 4 8 3 7 3 4 V 3',
	bd: 'M 5 0 C 9 0 10 1 10 5 C 10 9 9 10 5 10 C 1 10 0 9 0 5 C 0 1 1 0 5 0',
	be: 'M 0 0 L 4 12 L 1 11 L 1 15 L -1 15 L -1 11 L -4 12 Z'
};
...
var $author$project$Main$BoxModelNew = {$: 3};
var $author$project$Main$BoxYellow = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$Pointer = {$: 6};
var $author$project$Main$TipNew = {$: 5};
var $author$project$Main$Arrow = {$: 4};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$d($author$project$Main$p.aA)
						]),
					_List_Nil)
				]));
	});
...
var $author$project$Main$widthText = function (text) {
	return ($elm$core$String$length(text) * 10) + 16;
};
var $author$project$Main$viewBox = F2(
	function (argsFixed, args) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				$author$project$Main$attrsOffset(args.e),
				_List_fromArray(
					[
						...
						$elm$core$String$fromInt(
							$author$project$Main$widthText(argsFixed.b)) + 'px'),
						...
						$elm$html$Html$Attributes$style,
						'opacity',
						$elm$core$String$fromFloat(args.v)),
						A2($elm$html$Html$Attributes$style, 'background-color', argsFixed.l),
						A2($elm$html$Html$Attributes$style, 'color', argsFixed.o)
					])),
			_Utils_ap(
				function () {
					var _v0 = argsFixed.r;
				...
				_List_fromArray(
					[
						$elm$html$Html$text(argsFixed.b)
					])));
	});
var $elm$svg$Svg$Attributes$stroke = _VirtualDom_attribute('stroke');
var $elm$svg$Svg$Attributes$strokeWidth = _VirtualDom_attribute('stroke-width');
var $author$project$Main$viewPointer = F2(
	function (_v0, argsVariable) {
		var rotation = (argsVariable.e < 100) ? 10 : ((argsVariable.e < 140) ? (argsVariable.e - 90) : ((argsVariable.e < 160) ? (160 - argsVariable.e) : 10));
		return A2(
			$elm$svg$Svg$svg,
			_Utils_ap(
				$author$project$Main$attrsOffset($author$project$Main$p.ag),
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'opacity',
						$elm$core$String$fromFloat(argsVariable.v)),
						A2($elm$html$Html$Attributes$style, 'offset-rotate', '0deg'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$d($author$project$Main$p.be)
						]),
					_List_Nil)
				]));
	});
var $author$project$Main$viewTip = F2(
	function (argsFixed, args) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				...
				_List_fromArray(
					[
						...
						'width',
						$elm$core$String$fromInt(
							$author$project$Main$widthText(argsFixed.b) - 6) + 'px'),
						A2($elm$html$Html$Attributes$style, 'border-radius', '30px'),
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'transform',
							'translateY(48px) scale(' + ($elm$core$String$fromFloat((2 + argsVariable.v) / 3) + ')')),
							A2($elm$html$Html$Attributes$style, 'display', 'flex'),
...
var $author$project$Main$objectToHtml = function (object) {
	switch (object.$) {
		case 5:
			return {
				s: {l: 'red', o: 'white', b: 'New', r: $elm$core$Maybe$Nothing},
				w: $author$project$Main$viewTip
			};
		case 0:
			var text = object.a;
			return {
				s: {l: 'green', o: 'white', b: text, r: $elm$core$Maybe$Nothing},
				w: $author$project$Main$viewBox
			};
		case 1:
			var text = object.a;
			return {
				s: {l: 'rgb(255,220,0)', o: 'black', b: text, r: $elm$core$Maybe$Nothing},
				w: $author$project$Main$viewBox
			};
		case 2:
			var text = object.a;
			return {
				s: {l: $author$project$Main$p.D, o: 'white', b: text, r: $elm$core$Maybe$Nothing},
				w: $author$project$Main$viewBox
			};
		case 3:
			return {
				s: {
					l: $author$project$Main$p.D,
					o: 'white',
					b: 'Model',
					r: $elm$core$Maybe$Just('New')
				},
				w: $author$project$Main$viewBox
			};
		case 4:
			return {
				s: {l: 'rgba(18, 147, 216, 0.3)', o: '', b: '', r: $elm$core$Maybe$Nothing},
				w: $author$project$Main$viewArrow
			};
		case 6:
			return {
				s: {l: '', o: '', b: '', r: $elm$core$Maybe$Nothing},
				w: $author$project$Main$viewPointer
			};
		case 7:
			var string1 = object.a;
			var string2 = object.b;
			return {
				s: {l: '', o: '', b: string2, r: string1},
				w: $author$project$Main$viewTitle
			};
		default:
			return {
				s: {l: '', o: '', b: '', r: $elm$core$Maybe$Nothing},
				w: $author$project$Main$viewTitleInitial
			};
	}
};
var $author$project$Main$addPrecedingArrows = F2(
	function (speed, anim) {
		var widthBox = $author$project$Main$widthText(
			function ($) {
				return $.b;
			}(
				function ($) {
					...
					$author$project$Main$objectToHtml(anim.n))));
		var distanceBetweenBoxAndArrow = speed * (widthBox / 55);
		var distanceBetweenArrows = speed / 2.1;
		return _List_fromArray(
			[
				{n: $author$project$Main$Arrow, d: anim.d, f: anim.f - (distanceBetweenBoxAndArrow + distanceBetweenArrows), g: anim.g - (distanceBetweenBoxAndArrow + distanceBetweenArrows)},
				{n: $author$project$Main$Arrow, d: anim.d, f: anim.f - distanceBetweenBoxAndArrow, g: anim.g - distanceBetweenBoxAndArrow},
				anim
			]);
	});
var $author$project$Main$timeline1 = F2(
	function (current, speed) {
		var startDelay = 7;
		var pathViewToDom = {c: $author$project$Main$p.aj, j: $author$project$Main$p.ag};
		var pathUpdateToView = {c: $author$project$Main$p.ai, j: $author$project$Main$p.aj};
		var pathStartToRuntime = {c: $author$project$Main$p.aS, j: $author$project$Main$p.au};
		var pathRuntimeToUpdate = {c: $author$project$Main$p.au, j: $author$project$Main$p.ai};
		var f0 = ($author$project$Main$p.at + (startDelay * speed)) + current;
		var f1 = f0 + ((pathStartToRuntime.j - pathStartToRuntime.c) * speed);
		var f2 = f1 + ((pathRuntimeToUpdate.j - pathRuntimeToUpdate.c) * speed);
		var f3 = f2 + ((pathUpdateToView.j - pathUpdateToView.c) * speed);
		var f4 = f3 + ((pathViewToDom.j - pathViewToDom.c) * speed);
		return _Utils_ap(
			_List_Nil,
			_Utils_ap(
				_List_fromArray(
					[
						{
						n: $author$project$Main$TipNew,
						d: {c: $author$project$Main$p.ah, j: $author$project$Main$p.ah},
						f: f4,
						g: ($author$project$Main$p.ah * speed) + f0
					}
					]),
				_Utils_ap(
					A2(
						...
						speed,
						{
							n: $author$project$Main$BoxYellow('Event'),
							d: pathStartToRuntime,
							f: f1,
							g: f0
						}),
					_Utils_ap(
						A2(
							...
							speed,
							{
								n: $author$project$Main$BoxAzzurro('Model'),
								d: pathRuntimeToUpdate,
								f: f2,
								g: f1
							}),
						_Utils_ap(
							_List_fromArray(
								[
									{
									n: $author$project$Main$BoxGreen('Msg'),
									d: pathRuntimeToUpdate,
									f: f2 + (speed * 1.5),
									g: f1 + (speed * 1.5)
								}
							...
							_Utils_ap(
								A2(
									$author$project$Main$addPrecedingArrows,
									speed,
									{n: $author$project$Main$BoxModelNew, d: pathUpdateToView, f: f3, g: f2}),
								_Utils_ap(
									A2(
										$author$project$Main$addPrecedingArrows,
										speed,
										{
											n: $author$project$Main$BoxYellow('Html'),
											d: pathViewToDom,
											f: f4,
											g: f3
										}),
...
var $author$project$Main$timeline2 = F2(
	function (current, speed) {
		var pathUpdateToEffects = {c: $author$project$Main$p.av, j: $author$project$Main$p.aQ};
		var pathEffectsToUpdate = {c: $author$project$Main$p.aR, j: $author$project$Main$p.av};
		var f0 = ($author$project$Main$p.at * speed) + current;
		var f1 = f0 + ((pathUpdateToEffects.j - pathUpdateToEffects.c) * speed);
		var delay = 10;
		var f1WithDelay = f1 + (delay * speed);
		var f2 = f1 + (((pathEffectsToUpdate.j - pathEffectsToUpdate.c) + delay) * speed);
		return _Utils_ap(
			A2(
				$author$project$Main$addPrecedingArrows,
				speed,
				{
					n: $author$project$Main$BoxYellow('Cmd'),
					d: pathUpdateToEffects,
					f: f1,
					g: f0
				}),
			A2(
				...
				speed,
				{
					n: $author$project$Main$BoxYellow('Response'),
					d: pathEffectsToUpdate,
					f: f2,
					g: f1WithDelay
				}));
	});
...
var $author$project$Main$TitleInitial = {$: 8};
var $author$project$Main$timelineTitleOpening = F2(
	function (current, speed) {
		return _List_fromArray(
			[
				{
				n: $author$project$Main$TitleInitial,
				d: {c: 0, j: 0},
				f: current + 180,
				g: current
			}
...
var $author$project$Main$updateCachedMaxCount = function (model) {
	return function (max) {
		...
		A3(
			...
			F2(
				function (anim, acc) {
					return A2($elm$core$Basics$max, acc, anim.f);
				}),
			0,
			model.H));
};
		...
		$author$project$Main$updateCachedMaxCount(
			{
				H: _Utils_ap(
					_List_Nil,
					_Utils_ap(
						A2($author$project$Main$timeline1, 400, $author$project$Main$p.P),
						_Utils_ap(
							A2($author$project$Main$timelineTitleChapter1, 200, $author$project$Main$p.P),
							_Utils_ap(
								A2($author$project$Main$timeline2, 1300, $author$project$Main$p.P),
								_Utils_ap(
									A2($author$project$Main$timelineTitleChapter2, 1100, $author$project$Main$p.P),
									A2($author$project$Main$timelineTitleOpening, 0, $author$project$Main$p.P)))))),
				I: 0,
				a: 0,
				V: 2,
				W: false,
...
var $author$project$Main$isAnimationPlaying = function (model) {
	return (_Utils_cmp(model.a, model.I) < 0) && (!model.L);
};
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {as: oldTime, a$: request, a1: subs};
	});
...
var $author$project$Main$ShowAllArrows = 0;
var $author$project$Main$ShowOneArrow = 1;
...
var $author$project$Main$ChangeSlider = function (a) {
	return {$: 6, a: a};
};
var $author$project$Main$ChangeState = function (a) {
	return {$: 0, a: a};
};
var $author$project$Main$CycleDebugArrowMode = {$: 4};
var $author$project$Main$Replay = {$: 2};
var $author$project$Main$Reset = {$: 1};
var $author$project$Main$ToggleDarkMode = {$: 8};
var $author$project$Main$ToggleFilter = {$: 9};
var $author$project$Main$ToggleTrackVisibility = {$: 7};
...
var $author$project$Main$attrsButton = F2(
	function (title, msg) {
		return _List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$viewBox('0 0 10 10'),
				$elm$svg$Svg$Attributes$width('40px'),
				$elm$svg$Svg$Attributes$fill($author$project$Main$p.D),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$d($author$project$Main$p.bd + (' ' + extra))
					]),
				_List_Nil)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$style,
				'width',
				$elm$core$String$fromInt($author$project$Main$p.N) + 'px')
			]),
		_List_fromArray(
			[
				A2(
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							if (!_v0) {
								return A2(
									...
									A2(
										...
										'Play',
										$author$project$Main$ChangeState(1)),
									_List_fromArray(
										[
											$author$project$Main$viewButtonTemplate($author$project$Main$p.a7)
										]));
							} else {
								return A2(
									$elm$html$Html$button,
									A2(
										$author$project$Main$attrsButton,
										'Pause',
										$author$project$Main$ChangeState(0)),
									_List_fromArray(
										[
											$author$project$Main$viewButtonTemplate($author$project$Main$p.a8)
										]));
							}
						}(),
							A2(
							...
							_List_fromArray(
								[
									$author$project$Main$viewButtonTemplate($author$project$Main$p.bb)
								])),
							A2(
							$elm$html$Html$button,
							...
							_List_fromArray(
								[
									$author$project$Main$viewButtonTemplate($author$project$Main$p.a4)
								])),
							A2(
							$elm$html$Html$button,
							...
							_List_fromArray(
								[
									$author$project$Main$viewButtonTemplate($author$project$Main$p.a6)
								])),
							A2(
							$elm$html$Html$button,
							...
							_List_fromArray(
								[
									$author$project$Main$viewButtonTemplate($author$project$Main$p.a3)
								])),
							A2(
							$elm$html$Html$button,
							...
							_List_fromArray(
								[
									$author$project$Main$viewButtonTemplate($author$project$Main$p.ba)
								])),
							A2(
							$elm$html$Html$button,
							A2($author$project$Main$attrsButton, 'Toggle Filter', $author$project$Main$ToggleFilter),
							_List_fromArray(
								[
									$author$project$Main$viewButtonTemplate($author$project$Main$p.a5)
								])),
							A2(
							$elm$html$Html$button,
							...
							_List_fromArray(
								[
									$author$project$Main$viewButtonTemplate($author$project$Main$p.a9)
								])),
							A2(
							$elm$html$Html$input,
							_List_fromArray(
								[
									...
									$elm$core$String$fromFloat(model.a)),
					...
					function () {
						var remainingTime = $elm$core$Basics$abs(model.I - model.a);
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Main$AddTimeline(
									A2($author$project$Main$timeline1, model.a, 1)))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$AddTimeline(
									A2($author$project$Main$timeline1, model.a, 3)))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$AddTimeline(
									A2($author$project$Main$timeline1, model.a, 5)))
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$AddTimeline(
									A2($author$project$Main$timeline1, model.a, 10)))
							]),
						_List_fromArray(
							[
					...
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$AddTimeline(
									A2($author$project$Main$timeline2, model.a, 1)))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Add 1')
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$AddTimeline(
									A2($author$project$Main$timeline2, model.a, 3)))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Add 3')
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$AddTimeline(
									A2($author$project$Main$timeline2, model.a, 5)))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Add 5')
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$AddTimeline(
									A2($author$project$Main$timeline2, model.a, 10)))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Add 10')
	...
	function (multiplier, svg) {
		return A2(
			...
			A2(
				$elm$core$List$map,
				function (item) {
					var _v0 = $elm$core$String$toFloat(item);
					if (!_v0.$) {
						var _float = _v0.a;
						return $elm$core$String$fromFloat(_float * multiplier);
					} else {
						return item;
					}
				},
...
var $author$project$Main$svgMainPath = A2($author$project$Main$svgMultiplier, 28, $author$project$Main$p.bc);
...
var $author$project$Main$viewAnimations = function (model) {
	return A2(
		...
		function (anim) {
			return ((_Utils_cmp(anim.g, model.a) < 0) && (_Utils_cmp(model.a, anim.f) < 0)) ? $elm$core$Maybe$Just(
				function () {
					var position = model.a - anim.g;
					var pathLength = anim.d.j - anim.d.c;
					var html = $author$project$Main$objectToHtml(anim.n);
					var animLength = anim.f - anim.g;
					var temp = position / animLength;
					var percentageAbsolute = (temp * pathLength) + anim.d.c;
					var percentageRelative = temp * 100;
					var opacity = (_Utils_cmp(percentageRelative, $author$project$Main$p.ao) < 0) ? (percentageRelative / $author$project$Main$p.ao) : ((_Utils_cmp(percentageRelative, 100 - $author$project$Main$p.ap) > 0) ? ((100 - percentageRelative) / $author$project$Main$p.ap) : 1);
					return A2(
						html.w,
						html.s,
						{v: opacity, e: percentageAbsolute});
				}()) : $elm$core$Maybe$Nothing;
		},
		model.H);
};
		...
		_Utils_ap(
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'height',
					$elm$core$String$fromFloat($author$project$Main$p.ak - size1) + 'px'),
					A2($elm$html$Html$Attributes$style, 'color', $author$project$Main$p.D),
					A2(
					$elm$html$Html$Attributes$style,
					'font-size',
...
var $author$project$Main$viewAreaSafe = $author$project$Main$viewMajorBlock(
	{
		af: _List_fromArray(
			[
				...
				$elm$html$Html$Attributes$style,
				'width',
				$elm$core$String$fromFloat((($author$project$Main$p.N - $author$project$Main$p._) / 2) - 50) + 'px'),
				A2($elm$html$Html$Attributes$style, 'background-color', $author$project$Main$p.am)
			]),
		b: 'Safe Area'
	});
		...
		_Utils_ap(
			...
			_List_fromArray(
				[
					...
					$elm$core$String$fromFloat(args.R * 2.14) + 'px'),
					...
					A2(
						...
						A2(
							...
							_List_fromArray(
								[(-args.R) + 5, 0, args.R + 5, 10])))),
					$elm$svg$Svg$Attributes$fill($author$project$Main$p.al)
				])),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Main$p.aA + (' ' + A3(
							$elm$core$String$replace,
							'{{size}}',
							$elm$core$String$fromFloat(args.R - 5),
							$author$project$Main$p.a2)))
					]),
				_List_Nil)
			]));
};
var $author$project$Main$viewBoxGeneric = F2(
	function (args1, args2) {
		return A2(
			$elm$html$Html$div,
			_Utils_ap(
				$author$project$Main$attrsOffset(args2.e),
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$style,
						'transform',
						'translateX(' + ($elm$core$String$fromFloat(args2.ac) + 'px)')),
						A2($elm$html$Html$Attributes$style, 'background-color', args1.l),
						A2($elm$html$Html$Attributes$style, 'color', args1.o),
						A2(
						$elm$html$Html$Attributes$style,
						'font-size',
						$elm$core$String$fromFloat($author$project$Main$fontSize) + 'px'),
			...
			_List_fromArray(
				[
					$elm$html$Html$text(args2.b)
				]));
	});
var $author$project$Main$viewBoxBlue = $author$project$Main$viewBoxGeneric(
	{l: 'rgba(18, 147, 216, 0.3)', o: $author$project$Main$p.D});
var $author$project$Main$viewBoxYellow = $author$project$Main$viewBoxGeneric(
	{l: 'rgba(255,230,0, 0.8)', o: 'rgba(100,100,0, 1)'});
var $elm$core$Basics$round = _Basics_round;
var $elm$core$Basics$ge = _Utils_ge;
var $author$project$Main$viewArrowForTesting = function (args) {
	return A2(
		$author$project$Main$viewArrow,
		{l: $author$project$Main$p.aD, o: '', b: '', r: $elm$core$Maybe$Nothing},
		{
			v: args.v,
			e: function () {
				var newCount = args.a + args.aq;
				return (newCount >= 200) ? (newCount - 200) : ((newCount >= 100) ? (newCount - 100) : newCount);
			}()
		});
};
			...
			return A2(
				...
				function (index) {
					return $author$project$Main$viewArrowForTesting(
						{a: model.a / debuggingArrowSpeed, aq: index / qty, v: 1});
				},
				A2(
					$elm$core$List$range,
					0,
					$elm$core$Basics$round(100 * qty)));
		default:
			return _List_fromArray(
				[
					$author$project$Main$viewArrowForTesting(
					{a: model.a / debuggingArrowSpeed, aq: 0, v: 1})
				]);
	}
};
var $author$project$Main$viewElmRuntime = $author$project$Main$viewMajorBlock(
	{
		af: _List_fromArray(
			[
				...
				$elm$html$Html$Attributes$style,
				'left',
				$elm$core$String$fromFloat(($author$project$Main$p.N - $author$project$Main$p._) / 2) + 'px'),
				A2(
				$elm$html$Html$Attributes$style,
				'width',
				$elm$core$String$fromFloat($author$project$Main$p._) + 'px'),
...
var $author$project$Main$viewObject = F2(
	function (object, args) {
		...
		return A2(f.w, f.s, args);
	});
var $author$project$Main$viewSvgTrack = function (model) {
	return model.X ? _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$width(
					$elm$core$String$fromInt($author$project$Main$p.N)),
					$elm$svg$Svg$Attributes$height(
					$elm$core$String$fromInt($author$project$Main$p.ak)),
					A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$d($author$project$Main$svgMainPath),
							$elm$svg$Svg$Attributes$fill('transparent'),
							$elm$svg$Svg$Attributes$stroke($author$project$Main$p.D),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$style,
				'height',
				$elm$core$String$fromInt($author$project$Main$p.ak) + 'px'),
				A2(
				$elm$html$Html$Attributes$style,
				'width',
				$elm$core$String$fromInt($author$project$Main$p.N) + 'px'),
				...
				A2(
					...
					A2(
						...
						$author$project$Main$viewBoxBlue(
							{e: $author$project$Main$p.ai, b: 'update', ac: 20}),
						A2(
							$elm$core$List$cons,
							$author$project$Main$viewBoxBlue(
								{e: $author$project$Main$p.aj, b: 'view', ac: 20}),
							A2(
								$elm$core$List$cons,
								$author$project$Main$viewBoxYellow(
									{e: $author$project$Main$p.ag, b: 'DOM', ac: -20}),
								A2(
									$elm$core$List$cons,
									$author$project$Main$viewBoxYellow(
										{e: $author$project$Main$p.aP, b: 'Effects', ac: 10}),
									_Utils_ap(
										A2(
											$elm$core$List$map,
											function (percentage) {
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				$elm$html$Html$text(
																				'.offset-box {offset-path: path(\'' + ($author$project$Main$svgMainPath + ('\')}' + ((model.Y ? $author$project$Main$cssForVintageFilter(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$style,
				'background-color',
				model.W ? 'rgb(30,30,30)' : 'rgb(255,255,255)')
			]),
		_List_fromArray(
			[
				A2(
